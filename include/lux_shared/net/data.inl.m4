...
m4_lux_net_data(NetSsTick, dynamic, day_cycle, player_id, entity_comps, dbg_inf,
    entities)
m4_lux_net_data(NetSsSgnl::Blocks::Chunk, static, id)
m4_lux_net_data(NetSsSgnl::Blocks, dynamic, chunks)
...
m4_lux_net_data(NetSsSgnl, tagged, `blocks, light, msg, rasen_label')
...
m4_lux_net_data(NetCsSgnl, tagged, `map_request, command, rasen_asm', actions)
